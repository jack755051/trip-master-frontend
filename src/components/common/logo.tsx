...
export default function Logo({ className }: LogoProps) {
  return (
    <Link
      ...
      className="inline-flex cursor-pointer rounded-sm transition-opacity hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand/40"
    >
      <svg
        width="240"
        height="80"
